...
wordCursorIsOn = function(line, column) {
  var charsAhead, leftMatch, leftOfCursor, nextWord, rightMatch, rightOfCursor, specialChars;
  ...
  return [leftMatch[0] + rightMatch[0], specialChars, charsAhead];
};
Motion = (function() {
...
map('*', (function() {
  ...
  _Class.prototype.exclusive = true;
  _Class.prototype.exec = function(jim) {
    var adaptor, charsAhead, pattern, specialChars, timesLeft, wholeWord, _ref2, _results;
    timesLeft = this.count;
    adaptor = jim.adaptor;
    _ref2 = wordCursorIsOn(adaptor.lineText(), adaptor.column()), pattern = _ref2[0], specialChars = _ref2[1], charsAhead = _ref2[2];
    if (charsAhead) {
      new MoveRight(charsAhead).exec(jim);
    }
    wholeWord = !specialChars;
    jim.search = {
      pattern: pattern,
      backwards: false,
      wholeWord: wholeWord
