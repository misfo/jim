(function() {
  ...
  define(function(require, exports, module) {
    ...
    Motion = (function() {
      ...
      Motion.prototype.exec = function(jim) {
        var timesLeft, _results;
        timesLeft = this.count;
        _results = [];
        while (timesLeft--) {
          _results.push(this.moveOnce(jim));
        }
        return _results;
      };
    ...
    map('h', MoveLeft = (function() {
      ...
      MoveLeft.prototype.moveOnce = function(jim) {
    ...
    map('j', MoveDown = (function() {
      ...
      MoveDown.prototype.moveOnce = function(jim) {
    ...
    map('k', MoveUp = (function() {
      ...
      MoveUp.prototype.moveOnce = function(jim) {
    ...
    map('l', MoveRight = (function() {
      ...
      MoveRight.prototype.moveOnce = function(jim) {
    ...
    map('e', MoveToWordEnd = (function() {
      ...
      MoveToWordEnd.prototype.moveOnce = function(jim) {
        var column, firstMatchOnSubsequentLine, line, nextMatch, regex, rightOfCursor, row, thisMatch, _ref;
        regex = this.bigWord ? WORDRegex() : wordRegex();
        line = jim.adaptor.lineText();
        _ref = jim.adaptor.position(), row = _ref[0], column = _ref[1];
    ...
    map('w', MoveToNextWord = (function() {
      ...
      MoveToNextWord.prototype.moveOnce = function(jim) {
        var column, line, nextLineMatch, nextMatch, regex, rightOfCursor, row, thisMatch, _ref;
        regex = this.bigWord ? WORDRegex() : wordRegex();
        line = jim.adaptor.lineText();
        _ref = jim.adaptor.position(), row = _ref[0], column = _ref[1];
        rightOfCursor = line.substring(column);
    ...
    map('b', MoveBackWord = (function() {
      ...
      MoveBackWord.prototype.moveOnce = function(jim) {
        var column, leftOfCursor, line, match, regex, row, _ref;
    ...
    map('f', GoToNextChar = (function() {
      ...
      GoToNextChar.prototype.exec = function(jim) {
        var column, columnsRight, rightOfCursor, row, timesLeft, _ref, _ref2;
        timesLeft = (_ref = this.count) != null ? _ref : 1;
    ...
    map('F', GoToPreviousChar = (function() {
      ...
      GoToPreviousChar.prototype.exec = function(jim) {
        var column, leftOfCursor, row, targetColumn, timesLeft, _ref, _ref2;
        timesLeft = (_ref = this.count) != null ? _ref : 1;
        _ref2 = jim.adaptor.position(), row = _ref2[0], column = _ref2[1];
