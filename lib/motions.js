(function() {
  ...
  define(function(require, exports, module) {
    ...
    Motion = (function() {
      ...
      Motion.prototype.move = function(jim, count) {
        var timesLeft, _results;
        timesLeft = !(count != null) || count === '' ? 1 : count;
        _results = [];
        while (timesLeft--) {
          _results.push(this.moveOnce.call(jim));
        }
        return _results;
      };
      Motion.prototype.change = function(jim, count) {
        ...
        jim.deleteSelection(this.exclusive, this.linewise);
        return jim.setMode('insert');
      };
      Motion.prototype["delete"] = function(jim, count) {
        jim.adaptor.setSelectionAnchor();
        this.move(jim, count);
        adjustSelection.call(this, jim);
    ...
    motions = {
      ...
      w: new Motion({
        ...
        change: function(jim, count) {
          return motions['w'].change(jim, count);
        }
      }),
      e: new Motion({
        moveOnce: function() {
      ...
      G: new Motion({
        ...
        move: function(jim, count) {
          ...
          lineNumber = count === '' ? jim.adaptor.lastRow() : count;
