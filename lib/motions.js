(function() {
  ...
  define(function(require, exports, module) {
    var Motion, WORDRegex, c, dualChar, k, lastWORDRegex, lastWordRegex, motions, moveBackWord, moveNextWord, moveWordEnd, singleChar, v, wordRegex;
    WORDRegex = function() {
      return /\S+/g;
    };
    wordRegex = function() {
    ...
    motions = {
      ...
      gg: new Motion({
        linewise: true,
        move: function(jim, count) {
          return motions['G'].move(jim, count != null ? count : 1);
        }
      }),
      '/': new Motion({
        exclusive: true,
