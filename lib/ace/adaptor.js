(function() {
  define(function(require, exports, module) {
    ...
    fixSelection = function(exclusive) {
      if (!exclusive && !this.editor.selection.isBackwards()) {
    ...
    return Adaptor = (function() {
      ...
      Adaptor.prototype.deleteSelection = function(exclusive) {
        var yank;
      ...
      Adaptor.prototype.selectionText = function(exclusive) {
        fixSelection.call(this, exclusive);
