(function() {
  define(function(require, exports, module) {
    var Jim, WORDRegex, actions, adaptor, isntCharacterKey, jim, lastWORDRegex, lastWordRegex, moveSelection, navigateBackWord, navigateNextWord, navigateWordEnd, wordRegex;
    Jim = require('jim/jim');
    jim = new Jim();
    ...
    actions = {
      ...
      deleteSelection: function(env, args) {
        var atLineEnd, lineLength, selectionLead;
