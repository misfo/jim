(function() {
  define(function(require, exports, module) {
    ...
    return Adaptor = (function() {
      ...
      Adaptor.prototype.find = function(text) {
        return this.editor.find(text);
      };
      Adaptor.prototype.findNext = function() {
        return this.editor.findNext();
      };
      Adaptor.prototype.findPrevious = function() {
        return this.editor.findPrevious();
      };
