(function() {
  define(function(require, exports, module) {
    ...
    regex = RegExp("^([iaIAC])|([vV])|(D)|(?:([cdy])?([1-9]\\d*)?(?:(" + motions.regex.source + ")|([[pPxXu]))?)$");
    return {
      execute: function() {
        var after, continueBuffering, count, countMatch, deleteCommand, deleteMotion, fullMatch, match, motion, motionObj, multipliableCommand, text, timesLeft, visualTransition;
