(function() {
  define(function(require, exports, module) {
    ...
    return {
      execute: function() {
        var after, column, continueBuffering, deleteCommand, deleteMotion, fullMatch, go, insertTransition, lineNumber, lineText, match, motion, multipliableCommand, numberPrefix, text, visualTransition, _ref;
        ...
        if (insertTransition) {
          ...
          lineNumber = numberPrefix === '' ? this.adaptor.lastRow() : numberPrefix;
          lineText = this.adaptor.lineText(lineNumber - 1);
          column = ((_ref = /\S/.exec(lineText)) != null ? _ref.index : void 0) || 0;
          this.adaptor.goToLine(lineNumber, column);
        } else {
