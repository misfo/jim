(function() {
  define(function(require, exports, module) {
    var MoveDown, MoveLeft, commands, invalidCommand, motions, operators, tokenize;
    commands = require('jim/commands');
    motions = require('jim/motions');
    operators = require('jim/operators');
    MoveLeft = motions.MoveLeft, MoveDown = motions.MoveDown;
    tokenize = function() {
      var command, motion;
      if (!this.command) {
    ...
    exports.onKeypress = function(keys) {
      ...
      tokenize.call(this);
      if ((_ref = this.command) != null ? _ref.isComplete() : void 0) {
