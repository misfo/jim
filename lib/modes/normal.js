(function() {
  define(function(require, exports, module) {
    ...
    return {
      execute: function() {
        var additionalLines, after, command, continueBuffering, count, countMatch, deleteMotion, fullMatch, insertSwitch, linewiseCommand, match, motion, motionCount, motionCountMatch, motionObj, operator, registerValue, row, startingPosition, text, timesLeft, visualSwitch, _ref;
