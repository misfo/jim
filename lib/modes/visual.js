(function() {
  ...
  define(function(require, exports, module) {
    ...
    return {
      execute: function() {
        var continueBuffering, count, countMatch, fullMatch, jim, match, motionMatch, operator, wasBackwards, _i;
        ...
        if (motionMatch[0]) {
          ...
          jim = this;
          this.adaptor.moveSelection(function() {
            return motions.move(jim, motionMatch, count);
          });
          if (wasBackwards) {
