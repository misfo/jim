(function() {
  define(function(require, exports, module) {
    ...
    return Jim = (function() {
      ...
      Jim.prototype.deleteSelection = function(exclusive) {
        return this.registers['"'] = this.adaptor.deleteSelection(exclusive);
      };
      Jim.prototype.yankSelection = function(exclusive) {
        return this.registers['"'] = this.adaptor.selectionText(exclusive);
      };
