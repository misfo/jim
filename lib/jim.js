(function() {
  ...
  UndoManager = (function() {
    ...
    UndoManager.prototype.isJimMark = function(entry, markName) {
      var deltas;
    ...
    UndoManager.prototype.markInsertStartPoint = function(doc) {
      var options;
      options = {
        args: [
          {
    ...
    UndoManager.prototype.markInsertEndPoint = function(doc) {
      var options;
      options = {
        args: [
          {
