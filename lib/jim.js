(function() {
  ...
  aceAdaptor = {
    ...
    selectUp: function(env, args, request) {
      return env.editor.selection.selectUp(args.times);
    },
    selectDown: function(env, args, request) {
      return env.editor.selection.selectDown(args.times);
    },
    selectLeft: function(env, args, request) {
      return env.editor.selection.selectLeft(args.times);
    },
    selectRight: function(env, args, request) {
      return env.editor.selection.selectRight(args.times);
    },
