(function() {
  ...
  Jim = (function() {
    ...
    Jim.prototype.setMode = function(modeName) {
      ...
      if (this.mode !== prevMode) {
        return typeof this.onModeChange === "function" ? this.onModeChange.apply(this, modeParts) : void 0;
      }
    };
  ...
  Jim.modes.normal = {
    ...
    parse: function(buffer) {
      ...
      if (insertTransition) {
        ...
        changeToMode = visualTransition === 'V' ? 'visual:linewise' : 'visual:characterwise';
  ...
  define(function(require, exports, module) {
    ...
    startup = function(data, reason) {
      ...
      jim.onModeChange = function(mode, modeType) {
        if (mode === 'normal') {
