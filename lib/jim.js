(function() {
  var Jim, UndoManager, aceAdaptor, jim, motions;
  motions = {
    map: {
      h: 'Left',
      j: 'Down',
  ...
  UndoManager = (function() {
    ...
    UndoManager.prototype.markInsertStartPoint = function() {
      var options;
    ...
    UndoManager.prototype.markInsertEndPoint = function() {
      var options;
    ...
    UndoManager.prototype.jimUndo = function() {
      var deltas, _ref;
      console.log('UndoManager::jimUndo');
      deltas = (_ref = this.$undoStack[this.$undoStack.length - 1]) != null ? _ref.deltas : void 0;
      console.log('deltas', deltas);
      if (deltas === 'jimInsertEnd') {
        return console.log('roll a bunch of stuff back...');
      } else {
  ...
  aceAdaptor = {
    ...
    navigateBackWORD: function(env, args) {
      ...
      if ((args != null ? args.times : void 0) > 1) {
        args.times--;
        return aceAdaptor.navigateBackWORD(env, args);
      }
    },
    navigateNextWORD: function(env, args) {
      ...
      if ((args != null ? args.times : void 0) > 1) {
        args.times--;
        return aceAdaptor.navigateNextWORD(env, args);
      }
    },
    ...
    startup = function(data, reason) {
      ...
      jim.onModeChange = function(prevMode) {
        ...
        if (this.modeName === 'insert') {
          return undoManager.markInsertStartPoint();
        } else if (prevMode === 'insert') {
          return undoManager.markInsertEndPoint();
        }
      };
