(function() {
  ...
  jim = new Jim();
  aceAdaptor = {
    onEscape: function(env, args, request) {
    ...
    deleteLeft: function(env, args, request) {
      aceAdaptor.selectLeft(env, args, request);
      return aceAdaptor.deleteSelection(env, args, request);
    },
    deleteRight: function(env, args, request) {
      aceAdaptor.selectRight(env, args, request);
      return aceAdaptor.deleteSelection(env, args, request);
    },
    deleteToLineEnd: function(env, args, request) {
      env.editor.selection.selectLineEnd();
      return aceAdaptor.deleteSelection(env, args, request);
    },
    deleteSelection: function(env, args, request) {
    ...
    selectLine: function(env, args, request) {
      return env.editor.selection.selectLine();
    },
    yankSelection: function(env, args, request) {
      var start;
      jim.registers[args.register] = env.editor.getCopyText();
