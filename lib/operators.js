(function() {
  ...
  define(function(require, exports, module) {
    ...
    _ref = require('jim/motions'), GoToLine = _ref.GoToLine, MoveToFirstNonBlank = _ref.MoveToFirstNonBlank, MoveToNextBigWord = _ref.MoveToNextBigWord, MoveToNextWord = _ref.MoveToNextWord, MoveToBigWordEnd = _ref.MoveToBigWordEnd, MoveToWordEnd = _ref.MoveToWordEnd;
    defaultMappings = {};
    ...
    Operation = (function() {
      ...
      Operation.prototype.linewise = function(jim) {
        var _ref2;
        return jim.modeName === 'visual:linewise' || ((_ref2 = this.motion) != null ? _ref2.linewise : void 0);
      };
      Operation.prototype.visualExec = function(jim) {
        var _ref2;
        if (this.linewise(jim)) {
          jim.adaptor.makeLinewise();
        } else if (!((_ref2 = this.getMotion()) != null ? _ref2.exclusive : void 0)) {
          jim.adaptor.includeCursorInSelection();
        }
        this.operate(jim);
        if (this.switchToMode === 'insert' && this.repeatableInsertString) {
          return jim.adaptor.insert(this.repeatableInsertString);
        } else {
    ...
    map('c', Change = (function() {
      ...
      Change.prototype.operate = function(jim) {
        var linewise, motion;
        motion = this.getMotion();
        linewise = this.linewise(jim);
        if (linewise) {
          jim.adaptor.moveToEndOfPreviousLine();
        }
        return jim.deleteSelection(motion != null ? motion.exclusive : void 0, linewise);
      };
    ...
    map('d', Delete = (function() {
      ...
      Delete.prototype.operate = function(jim) {
        var linewise, _ref2;
        linewise = this.linewise(jim);
        jim.deleteSelection((_ref2 = this.motion) != null ? _ref2.exclusive : void 0, linewise);
        if (linewise) {
    ...
    map('y', Yank = (function() {
      ...
      Yank.prototype.operate = function(jim) {
        var _ref2, _ref3;
        jim.yankSelection((_ref2 = this.motion) != null ? _ref2.exclusive : void 0, this.linewise(jim));
